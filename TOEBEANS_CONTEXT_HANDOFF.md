...
* Phase 3 / M2 (vertical slice — polish ONE area end to end): IN PROGRESS.
  ...
  - [ ] Remaining M2 items: lighting/haze pass (next), real UI, sound (music + effects), save/load, character art. Direction questions on music/UI/sounds/cat-model are with the director.
