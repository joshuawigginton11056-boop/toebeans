...
* Phase 3 / M2 (vertical slice — polish ONE area end to end): IN PROGRESS.
  ...
  - [ ] Remaining M2 items: music direction + hookup, save/load, character art (skier/cat models under the assets item), then the end-of-M2 tuning pass (parked picky tweaks + carve volume).
